...
const enumInfo = [
  '✅ Status da Proposta (EStatusSituacaoProposta)',
  'Cotacao → Description: "CO"',
  'Rascunho → Description: "RA"',
  'PendenteAssinatura → Description: "PA"',
  'PendenteSensibilizacao → Description: "PS"',
  'Sensibilizado → Description: "SE"',
  'Cancelado → Description: "CA"',
  'Reenvio → Description: "RE"',
  'ErroSensibilizacao → Description: "ES"',
  'Expirada → Description: "EX"',
  'PendenteCartao → Description: "PC"',
  '✅ Status da Assinatura (EStatusAssinatura)',
  'SO → Description: "Solicitado"',
  'CO → Description: "Concluído"',
  'PE → Description: "Pendente"',
  'ER → Description: "Erro"',
  '✅ Canal (ECanal)',
  'OUTROS = 0',
  'PAR = 2',
  ...
  'AGE = 8',
  'Internet = 9',
  '✅ Sistema Origem (ESistemaOrigem)',
  'SemOrigem = 0 → Description: "Sem Origem"',
  'PortalVendas = 1 → Description: "Portal de Vendas"',
  'CaixaTem = 2 → Description: "Caixa Tem"',
  'Autocompras = 3 → Description: "Autocompras"',
  'PlataformaCaixa = 4 → Description: "Plataforma"',
  'Checkout = 5 → Description: "Checkout"',
  'CaixaMais = 6 → Description: "Caixa +"',
  'VidaBackend = 7 → Description: "Vida Backend"',
  'AutoCompraVida = 8 → Description: "AutoCompra Vida"',
  'AutoCompraPrevidencia = 9 → Description: "AutoCompra Previdência"',
  '✅ Forma de Pagamento (EFormaPagamento)',
  'DebitoAutomatico = 1 → Description: "Débito Automático"',
  'Boleto = 2 → Description: "Boleto"',
  'CartaoCredito = 3 → Description: "Cartão de Crédito"',
  'Pix = 4 → Description: "Pix"',
].join('\n');
